...
<template>
  ...
  <div id="interface-area">
    ...
    <div class="border border-1 border-green-200 m-2 p-2">
      ...
      <button @click="onUpdateGrid" class="m-4 p-2 bg-green-400 hover:bg-green-300 active:bg-green-600 text-slate-800">
    ...
    <div class="border border-1 border-green-200 m-2 p-2">
      ...
      <button @click="onUpdateHouse" class="m-4 p-2 bg-green-400 hover:bg-green-300 active:bg-green-600 text-slate-800">
